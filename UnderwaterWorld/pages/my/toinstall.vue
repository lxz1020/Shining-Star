	...
	<view class="registertitle">
		<form class='loginView' @submit="login">
			...
			<view class="tologin">
				...
				<view class="input-view">
					<view class="label-view">
						<u-icon name="lock-fill" size="40rpx"></u-icon>上传二维码
					</view>
					<u-upload :custom-btn="true" v-model="collectionImg">
						<view slot="addBtn" class="slot-btn" hover-class="slot-btn__hover" hover-stay-time="150">
							<u-icon name="photo" size="60" :color="$u.color['lightColor']"></u-icon>
						</view>
					</u-upload>
					<!-- <u-upload ref="uUpload" :action="action" :auto-upload="false"  v-model="collectionImg"/></u-upload> -->
