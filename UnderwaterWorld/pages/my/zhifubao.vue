<template>
	<view class="content" :style="{ height: this.app_height * 0.5 * 2  + 'rpx' }">
		...
		<!-- <view class="text-area">
				<image src="../../static/underwater.png" mode=""
		...
		<view  style="display: flex;width: 100%;flex-wrap: wrap;">
			...
			<view class="record" v-for="(item,i) in dataArray">
				...
				<view class="animal">
					<view class="">
						账号:{{item.collectionAccount}}
					</view>
				</view>
				<view class="animal">
					<view class="">
						收款手机号:{{item.collectionMobile}}
					</view>
					
				</view>
				<view class="animal">
					<view class="">
						收款人:{{item.collectionName}}
					</view>
				</view>
			</view>
			
				<u-button class="custom-style">
					<navigator url="./zfbtoinstall" open-type="navigate" class="tio">
					去添加
					</navigator>
				</u-button>
				<u-button class="custom-style-update">
					<navigator url="./zfbtoupdate" open-type="navigate" class="tio">
					去修改
					</navigator>
				</u-button>
		</view>
