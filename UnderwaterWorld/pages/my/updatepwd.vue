		...
		<form class='loginView' @submit="login">
			...
			<view class="tologin">
				...
				<view class="input-view">
					...
					<input class="input" type="text" placeholder="新密码" name="passwordValue" v-model="firstPassword"/>
				</view>
				...
				<view class="input-view">
					...
					<input class="input" type="text" placeholder="确认密码" name="nameValue" v-model="secondPassword" >
					</input>
				</view>
				<view style="display: flex;align-items: center;justify-content: center;">
						<u-line color="#CFB53B" length="80%" />
				...
				shape="circle"  @tap='submit' :ripple="true" ripple-bg-color="#FAFAD2">修改</u-button>
				</view>
			</view>
			</form>
	</view>
